...
export const invitation_tpl = `Gentile {{{nome}}}\n\r
ti ringraziamo voler dedicare quache minuto al questionario {{{titolo}}}\n\r
Per procedere con la compilazione usa il seguente link\n\r
{{{link}}}\r\r
Grazie`;

export const reminder_tpl = `Gentile {{{nome}}}\n\r
ad oggi risulta che non hai ancora compleato il questionario {{{titolo}}}\n\r
Per procedere con la compilazione usa il seguente link\n\r
{{{link}}}\n\r
Grazie`;

export const invitation_subject = "Questionario Mobility Manager - Invito";
export const reminder_subject = "Questionario Mobility Manager - Promemoria";
...
export const survey_components = {
        ...
        //Personalizzo questo dato per mobilitysquare
		"questionario-sede-azienda": () => import("@/theme/mobilitysquare/components/QuestionarioAzienda/Sede/Azienda.vue"),
